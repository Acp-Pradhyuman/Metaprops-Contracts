//address: 0x1aaEDFcc8bDF6FB05dFFbdC7EBd0434Ed61739fD
...
contract NFT8 is ERC721URIStorage, EIP712 {
    ...
    //     require(
    //         block.timestamp < endAt[_nftId],
    //         "only called within the auction duration!"
    //     );
    //     require(!ended[_nftId], "Auction already ended!");
    //     require(
    //         seller[_nftId] == msg.sender,
    //         "only a seller can cancel an auction"
    //     );
    ...
    function withdraw(uint256 _nftId) external payable {
        require(ended[_nftId], "Auction not ended!");
